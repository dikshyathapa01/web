          ...
          <div className="space-y-16 max-w-5xl mx-auto">
            {detailedServices.map((service, index) => (
              <div key={index} className={`flex flex-col ${index % 2 !== 0 ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8 md:gap-16 items-center`}>
                <div className="flex-1 w-full glass-card p-8 md:p-12 rounded-3xl border border-white/10 relative overflow-hidden">
                  {/* Decorative background */}
                  <div className={`absolute -bottom-20 ${index % 2 === 0 ? '-right-20' : '-left-20'} w-64 h-64 bg-primary/20 rounded-full blur-[60px]`}></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-8">
                      <div className="text-sm font-medium text-primary mb-1 uppercase tracking-wider">Starting at</div>
